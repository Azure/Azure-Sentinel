# Zscaler ZIA ASIM NetworkSessions Normalization Parser

This template deploys the ASIM NetworkSessions schema parser for Zscaler ZIA. The parser is a part of the Advanced SIEM Information Model.
