...
This template deploys the ASIM DNS schema parametrized parser for Microsoft Windows Sysmon. The parser is a part of the Advanced Security Information Model.
