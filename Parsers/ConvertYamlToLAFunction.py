...
EXCLUDE_FILES = {
    "ASimRegistryEventSentinelOne.yaml",
    "ASimRegistryEventTrendMicroVisionOne.yaml",
    "ASimRegistryEventVMwareCarbonBlackCloud.yaml",
    "vimRegistryEventSentinelOne.yaml",
    "vimRegistryEventTrendMicroVisionOne.yaml",
    "vimRegistryEventVMwareCarbonBlackCloud.yaml",
    "ASimWebSessionPaloAltoCortexDataLake.yaml",
    "vimWebSessionPaloAltoCortexDataLake.yaml",
    "ASimAuditEventCrowdStrikeFalconHost.yaml",
    "vimAuditEventCrowdStrikeFalconHost.yaml",
    "ASimAuditEventSentinelOne.yaml",
    "vimAuditEventSentinelOne.yaml",
    "ASimAuditEventVMwareCarbonBlackCloud.yaml",
    "vimAuditEventVMwareCarbonBlackCloud.yaml"
    "ASimDnsSentinelOne.yaml",
    "vimDnsSentinelOne.yaml"}  # Add filenames to exclude here
...
class Schema:
    ...
    def get_all_schema_parsers(self):
        all_parsers_files = [
            f for f in os.listdir(self.directory + "/" + self.parsers_relative_path)
...
def main():
    ...
    PARSERS_NAMES = {}
    schemas = [Schema("AssetEntity", "ASimAssetEntity", f"{KQL_DIRECTORY}/AssetEntity", "content/NGSchemas/SentinelAsim/AssetEntity.manifest.json")]
    #[Schema("Dns", "ASimDns", f"{KQL_DIRECTORY}/DNS", "content/NGSchemas/SentinelAsim/Dns.manifest.json")]
            ...
            #    Schema("FileEvent", "AsimFileEvent", f"{KQL_DIRECTORY}/FileEvent", "content/NGSchemas/SentinelAsim/ASimTables.manifest.json"),
            #    Schema("ProcessEvent", "AsimProcessEvent", f"{KQL_DIRECTORY}/ProcessEvent", "content/NGSchemas/SentinelAsim/ProcessEvent.manifest.json"),
            #    Schema("RegistryEvent", "AsimRegistryEvent", f"{KQL_DIRECTORY}/RegistryEvent", "content/NGSchemas/SentinelAsim/ASimTables.manifest.json"),
            #    Schema("UserManagement", "AsimUserManagement", f"{KQL_DIRECTORY}/UserManagement", "content/NGSchemas/SentinelAsim/ASimTables.manifest.json"),
            #    Schema("DhcpEvent", "AsimDhcpEvent", f"{KQL_DIRECTORY}/DhcpEvent", "content/NGSchemas/SentinelAsim/ASimTables.manifest.json"),
            #    Schema("AlertEvent", "ASimAlertEvent", f"{KQL_DIRECTORY}/AlertEvent", "content/NGSchemas/SentinelAsim/AlertEvent.manifest.json")
            ...
            #    Schema("AuthenticationEvent", "ASimAuthentication", f"{KQL_DIRECTORY}/AuthenticationEvent", "content/NGSchemas/SentinelAsim/AuthenticationEvent.manifest.json")
