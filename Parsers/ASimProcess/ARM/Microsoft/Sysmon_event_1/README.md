# sysmon events (1) Process Normalization Parser

This template deploys a ASim Process schema parser for sysmon - eventId number 1. The parser is a part of the Azure Sentinel Information Mode.
