# Microsoft Defender for Endpoints process events Normalization Parser

This template deploys the ASIM Process schema parser for Microsoft Defender for Endpoints. The parser is a part of the Azure Sentinel Information Mode.
