# Changelog for ASimAuthenticationArubaNetworksClearPass.yaml
...
- (2026-09-24) Initial creation of the parser
    ...
    - For TACACS (`2003`), keep only `TACACS_AUTHENTICATION` / `AUTHEN` (or missing request type). `TACACS_AUTHORIZATION` requests are dropped.
