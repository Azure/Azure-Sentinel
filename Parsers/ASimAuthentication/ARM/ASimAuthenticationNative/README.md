# Native ASIM Authentication Normalization Parser

ARM template for ASIM Authentication schema parser for Native.
...
- [CHANGELOG](https://github.com/Azure/Azure-Sentinel/blob/master/Parsers/ASimAuthentication/CHANGELOG/ASimAuthenticationNative.md)
