...
This ASIM parser supports filtering and normalizing Microsoft AAD managed identity authentication logs, produced by the Microsoft AAD connector, to the ASIM Authentication normalized schema.
