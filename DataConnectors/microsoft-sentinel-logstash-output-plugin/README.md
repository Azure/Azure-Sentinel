...
Microsoft Sentinel provides a new output plugin for Logstash. Using this output plugin, you will be able to send any log you wish using Logstash to the Microsoft Sentinel/Log Analytics workspace (through Log Analytics DCR based custom logs API).
...
2) To ingest the data to a standard table like Syslog or CommonSecurityLog use [Tutorial - Send custom logs to Azure Monitor Logs using resource manager templates - Azure Monitor | Microsoft Docs](<https://docs.microsoft.com/en-us/azure/azure-monitor/logs/tutorial-custom-logs-api>).
...
- **dcr_immutable_id** - String, The value of the DCR immutableId (see the "Collect information from DCR" section in [Tutorial - Send custom logs to Azure Monitor Logs (preview) - Azure Monitor | Microsoft Docs](<https://docs.microsoft.com/en-us/azure/azure-monitor/logs/tutorial-custom-logs#collect-information-from-dcr>).
