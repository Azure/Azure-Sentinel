  ...
  "Statement": [
    {
      ...
      "Condition": {
        "ArnLike": {
          "aws:SourceArn": "arn:aws-us-gov:s3:*:*:${bucketName}"
        }
      }
    },
    {
  ...
  "Statement": [
    {
      ...
      "Action": "s3:PutObject",
      "Resource": "arn:aws-us-gov:s3:::${bucketName}/AWSLogs/${callerAccount}/*",
      "Condition": {
        "StringEquals": {
  ...
  "Statement": [
    {
      ...
      "Action": "s3:PutObject",
      "Resource": "arn:aws-us-gov:s3:::${bucketName}/AWSLogs/${organizationId}/*",
      "Condition": {
        "StringEquals": {
          "s3:x-amz-acl": "bucket-owner-full-control"
        }
