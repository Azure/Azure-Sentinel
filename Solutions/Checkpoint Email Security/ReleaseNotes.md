...
|-------------|--------------------------------|--------------------------------------------------------------|
| 3.0.2       | 10-09-2026                     | Reduced duplicate ingestion by correcting security-event cursor placement and treating anti-phishing and spam exception endpoints as daily non-paginated snapshots |
