...
|---|---|---|
| 3.0.3       | 21-09-2026                     | Updated the Atlassian Organization Audit data connector to enable multi-select connection management. |
| 3.0.2       | 13-08-2026                     | Promoted the Atlassian Organization Audit data connector to GA. |
