...
The size and number of indicators imported is limited by logic apps file size and number of items. [Read more here](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-limits-and-config?tabs=consumption%2Cazure-portal)
