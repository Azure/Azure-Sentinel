...
|-------------|--------------------------------|---------------------------------------------------------------------------|
| 3.0.5       | 24-09-2026                     | Updated **Analytic Rule** PowerShell Encoded Command Execution to support `-e`, decode Base64 payloads, and evaluate download-cradle indicators against decoded content. |
