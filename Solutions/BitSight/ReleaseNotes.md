...
|-------------|--------------------------------|--------------------------------------------------------------------|
| 3.3.1       | 19-05-2026                     | Updated solution ownership to Microsoft; fixed **Parser** table references for CCF connectors (BitSightCompanyRatingDetails, BitSightFindingsCCF, BitSightVulnerabilitiesFindingsSummary); standardized parser filename casing |
