...
|-------------|--------------------------------|--------------------------------------------------------------------|
| 3.2.1       | 01-09-2026                     | Simplified authentication for the **BitSight Security Statistics** and **BitSight Security Events** CCF connectors to use a single API Token field. |
