<<<<<<< HEAD:DataConnectors/Trend Micro/AzureFunctionTrendMicroXDR/timer_trigger_oat/__init__.py
import logging
import typing
...
def main(mytimer: func.TimerRequest, msg: func.Out[typing.List[str]]) -> None:
    ...
    if error:
        raise error
>>>>>>> master:Solutions/Trend Micro Vision One/Data Connectors/AzureFunctionTrendMicroXDR/timer_trigger_oat/__init__.py
