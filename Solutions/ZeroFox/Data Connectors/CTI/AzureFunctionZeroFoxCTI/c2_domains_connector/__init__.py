...
def main(mytimer: func.TimerRequest) -> None:
    ...
    results = get_cti_c2_domains(zf_client, created_after= query_from, created_before= query_to)

    logging.info("Trigger function retrieved results")

    # The log type is the name of the event that is being submitted
    log_type = "ZeroFox_CTI_C2"
...
def get_cti_c2_domains(client: ZeroFoxClient, created_after: str, created_before: str):
