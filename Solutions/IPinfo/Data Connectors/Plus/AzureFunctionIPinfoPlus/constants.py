...
__all__ = [
    ...
    'PLUS_DCR_NAME', 'PLUS_TABLE_NAME', 'PLUS_STREAM_DECLARATION', 
    'AZURE_SCOPE', 'AZURE_BASE_URL', 'IPINFO_BASE_URL', 'MMDB_NAME', 
    'PLUS_TABLE_SCHEMA', 'PLUS_TABLE_COLUMNS'
]
...
PLUS_DCR_NAME = f"ipinfo_rule_for_PLUS_tables-{WORKSPACE_NAME.lower()}"
PLUS_TABLE_NAME = "Ipinfo_PLUS_CL"
PLUS_STREAM_DECLARATION = "Custom-Ipinfo_PLUS_CL"
...
PLUS_TABLE_SCHEMA = {
    "properties": { 
        ...
        "schema": {
            ...
            "columns": [
                ...
                {"name": "radius", "type": "int", "isDefaultDisplay": False, "isHidden": False},
                ...
                {"name": "as_changed", "type": "datetime", "isDefaultDisplay": False, "isHidden": False},
                {"name": "geo_changed", "type": "datetime", "isDefaultDisplay": False, "isHidden": False},
                ...
                {"name": "is_proxy", "type": "boolean", "isDefaultDisplay": False, "isHidden": False},
                {"name": "is_relay", "type": "boolean", "isDefaultDisplay": False, "isHidden": False},
                {"name": "is_tor", "type": "boolean", "isDefaultDisplay": False, "isHidden": False},
                {"name": "is_vpn", "type": "boolean", "isDefaultDisplay": False, "isHidden": False},
            ],
    ...
    "id": f"/subscriptions/{SUBCRIPTION_ID}/resourceGroups/{RESOURCE_GROUP_NAME}/providers/Microsoft.OperationalInsights/workspaces/{WORKSPACE_NAME}/tables/{PLUS_TABLE_NAME}",
    "name": PLUS_TABLE_NAME,
}
...
PLUS_TABLE_COLUMNS = {
    "columns": [
        ...
        {"name": "as_changed", "type": "datetime"},
        {"name": "geo_changed", "type": "datetime"},
