...
__all__ = [
    ...
    'SCHEDULE', 'LOCATION', 'SUBCRIPTION_ID', 'RESOURCE_GROUP_NAME',
    'WORKSPACE_NAME', 'CRON', 'RETENTION_IN_DAYS', 'TOTAL_RETENTION_IN_DAYS',
    'DATA_COLLECTION_ENDPOINT_NAME', 'PRIVACY_DCR_NAME', 'PRIVACY_TABLE_NAME',
    'PRIVACY_STREAM_DECLARATION', 'AZURE_SCOPE', 'AZURE_BASE_URL', 'IPINFO_BASE_URL',
    'MMDB_NAME', 'PRIVACY_TABLE_SCHEMA', 'PRIVACY_TABLE_COLUMNS'
]
