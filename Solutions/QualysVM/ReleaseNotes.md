...
|-------------|--------------------------------|----------------------------------------------------------------|
| 3.0.12       | 11-09-2026                     | Updated the Qualys Host Detection V3 parser to fully expand DetectionList records, preserve Qualys API v5 vulnerability fields including QDS and Unique Vulnerability ID, and request detection results. |
