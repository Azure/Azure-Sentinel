"""Init file for Mimecast SEG CG function."""

import datetime
import logging
import azure.functions as func
import time
from .mimecast_cg_to_sentinel import MimecastCGToSentinel
...
async def main(mytimer: func.TimerRequest) -> None:
    ...
    mimecast_to_sentinel_obj = MimecastCGToSentinel(int(start))
    await mimecast_to_sentinel_obj.get_mimecast_cg_data_in_sentinel()
    end = time.time()
