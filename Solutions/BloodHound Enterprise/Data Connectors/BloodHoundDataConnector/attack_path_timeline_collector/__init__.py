...
CONTAINER_NAME = "attack-path-timeline-function-state"
BLOB_NAME = "attack_path_timeline_collector_state.json"
...
def main(myTimer: func.TimerRequest) -> None:
    try:
        ...
        logging.info(f"Last attack path timeline timestamp from Azure Blob Storage: {last_attack_path_timeline_timestamp}")
        ...
        if new_attack_path_timeline_timestamp:
            # Update state in Azure Blob Storage only if we got valid results
