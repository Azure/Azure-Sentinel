...
|-------------|--------------------------------|--------------------------------------------------------------------------------|
| 3.3.4       | 30-04-2026                     | remove deprecated tag. CrowdStrike Falcon Data Replicator (AWS S3) is used by gov, while CrowdStrike Falcon Data Replicator (CrowdStrike Managed AWS-S3) is for the public |
