...
|-------------|--------------------------------|--------------------------------------------------------------------------------|
| 3.1.5       | 19-08-2025                     | Retracted the CrowdStrike API Data Connector (via Codeless Connector Framework) from the solution as there are major issues for Authentication and duplicatation of logs.The connector will be released again after the fix. |
