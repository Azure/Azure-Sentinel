...
|-------------|--------------------------------|--------------------------------------------------------------------------|
| 3.5.2       | 15-09-2026                     | Fixed **GitHub Enterprise Audit Log CCF Data Connector** deployment dependencies and UTC query-time formatting, and updated the **GitHubAuditData Parser** to retain events when source timestamp fields are unavailable. |
