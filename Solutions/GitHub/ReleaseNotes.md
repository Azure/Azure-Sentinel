...
|-------------|--------------------------------|--------------------------------------------------------------------------|
| 3.5.2       | 01-09-2026                     | GitHubAuditData parser: keep ingestion TimeGenerated when created_at_d/CreatedAt is missing so rows are not dropped, and timestamp coalesce defaults use long(null) for type safety. |
