...
> [!NOTE]
> For solution release notes and version history, see [Release Notes](../ReleaseNotes.md).

| **Version** | **Date Modified (DD-MM-YYYY)** | **Change History** |
| --- | --- | --- |
| 1.1.14| 11-09-2026 | Add XML sanitization and fix RFC exception propagation |
