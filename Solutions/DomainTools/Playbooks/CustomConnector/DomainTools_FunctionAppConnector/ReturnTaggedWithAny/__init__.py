...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        tagged_with_any = req.params.get("tagged_with_any")
        ...
        if not tagged_with_any:
            try:
                req_body = req.get_json()
            except ValueError:
                pass
            else:
                tagged_with_any = req_body.get("tagged_with_any")
        ...
        params = {"tagged_with_any": tagged_with_any}
        if active:
