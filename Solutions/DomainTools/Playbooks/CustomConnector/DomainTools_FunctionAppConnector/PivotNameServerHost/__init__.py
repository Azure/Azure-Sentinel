...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        nameserver_host = req.params.get("nameserver_host")
        ...
        if not nameserver_host:
            try:
                req_body = req.get_json()
            except ValueError:
                pass
            else:
                nameserver_host = req_body.get("nameserver_host")
        ...
        params = {"nameserver_host": nameserver_host}
        if active:
