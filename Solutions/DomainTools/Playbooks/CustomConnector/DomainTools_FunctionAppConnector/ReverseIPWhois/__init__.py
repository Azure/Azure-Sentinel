...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        include_total_count = req.params.get("include_total_count")
        page = req.params.get("page")
        ip_version = req.params.get("ip_version")
        if not query:
            try:
                ...
                include_total_count = req_body.get("include_total_count")
                page = req_body.get("page")
                ip_version = req_body.get("ip_version")
