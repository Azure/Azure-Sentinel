...
##############################
class StateManager:
    def __init__(self, connection_string, share_name='funcstatemarkershare', file_path='Eventsfuncstatemarkerfile'):
...
def main(mytimer: func.TimerRequest) -> None:
    ...
    try:
        ...
        logging.info("The number of Activities processed {} ".format(len(results_events)))
