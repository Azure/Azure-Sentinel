...
| ----------- | ------------------------------ | ------------------------ |
| 3.0.5       | 19-08-2026                     | Fixed ARM template expression escaping in the data connector polling config (stray `]`) that caused the **Connect** deployment to fail with a template language expression parse error. |
