...
## Introduction
The GCP Cloud Run Codeless Connector for Microsoft Sentinel enables seamless integration of Google Cloud Run logs with Microsoft Sentinel without the need for custom code. Developed as part of the Codeless Connector Platform(CCP), this connector simplifies the process of collecting and ingesting Cloud Run logs from Google Cloud Platform into Microsoft Sentinel.
...
To access the terraform script for Log Setup [Click here](https://github.com/v-anjohari/Cloud-Run-logs/tree/main/GCPCloudRunLogsSetup).
