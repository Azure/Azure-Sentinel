...
from SharedCode.extrahop_exceptions import ExtraHopException, SentinelIncorrectCredentialsException, InvalidDataFormatException
...
class MicrosoftSentinel:
    ...
    def post_data(self, body, log_type):
        ...
        Raises:
            ...
            ExtraHopException: When custom exception is raised.
        """
        ...
        while retry_count < consts.SENTINEL_RETRY_COUNT:
            try:
                ...
                raise ExtraHopException()
            except ExtraHopException as custom_err:
                applogger.error(
