...
|-------------|--------------------------------|-----------------------------------------------------------------------------|
| 3.1.1       | 30-07-2026                     | Restored security-relevant CloudGuard, audit-change, identity-attribution, and Bastion fields; table schema expanded from 86 to 121 columns. Aligned CCF DCR/table/poller packaging with `OracleCloudInfraConnector`. |
