...
sentinel_log_type = os.environ.get("ThreatHunts_table_name")
...
def main(request: func.HttpRequest) -> func.HttpResponse:
    ...
    """
    logging.info(
        "RubrikThreatHuntEvent({}): Start processing...".format(datetime.now())
    )
    ...
    try:
        ...
        logging.error("Value Error in RubrikThreatHuntEvent: {}".format(value_error))
        return func.HttpResponse(
            "Value Error - RubrikThreatHuntEvent: {}".format(value_error)
        )
