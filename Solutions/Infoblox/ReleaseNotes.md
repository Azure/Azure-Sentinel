...
|-------------|--------------------------------|---------------------------------------------|
| 3.1.2       |   19-08-2026                   | Migrated Dossier data ingestion in InfobloxCloudDataConnector to the Log Ingestion API (DCE/DCR) and updated the Data Connector UI page. |
