"""Init file for Infoblox Historical Function App."""
import datetime
import logging
...
def main(mytimer: func.TimerRequest) -> None:
    ...
    applogger.info(
        "{} : {}, Function App started at {}".format(
            ...
            consts.HISTORICAL_I_TO_S_FUNCTION_NAME,
    ...
    applogger.info(
        "{} : {}, Total time taken = {}".format(
            consts.LOGS_STARTS_WITH, consts.HISTORICAL_I_TO_S_FUNCTION_NAME, end - start
        )
    )
    if mytimer.past_due:
