...
|-------------|--------------------------------|--------------------------------------------------------------------|
| 3.1.1       | 05-08-2026                     | Updated CCF Connector Air Marshal polling to use checkpointed `t0` windowing instead of a fixed timespan to prevent duplicate ingestion. |
