...
|-------------|--------------------------------|---------------------------------------------------------------------------------------|
| 3.0.14      | 17-06-2026                     | Added new **Hunting Queries** Punycode chars lookalike domains, Hunt for RMM tool execution following Teams messages, Hunt for alerts correlated with Teams messages and Identify acting user for reported phish. Also corrected the incorrect mapping of `dataTypes: EmailEvents` with `connectorId: OfficeATP` across multiple **Hunting Queries**.	       |
