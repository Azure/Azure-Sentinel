...
|-------------|--------------------------------|---------------------------------------------------------------------------------------|
| 3.0.15       | 12-06-2026                     | Refactor OAuth and device-code phishing hunting queries to construct login.microsoftonline.com/.us URLs via strcat(); resolves ARM-TTK 'DeploymentTemplate Must Not Contain Hardcoded Uri' false positives. |
