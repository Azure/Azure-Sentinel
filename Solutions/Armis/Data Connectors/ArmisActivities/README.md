# ArmisActivities Integration for Azure Sentinel

## Introduction

This folder contains the Azure function time trigger code for ArmisActivities-Azure Sentinel connector. The connector will run periodically and ingest the ArmisActivities data into the Azure Sentinel logs custom table `Armis_Activities_CL`.
## Folders
