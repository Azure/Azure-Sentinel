...
from .const import (CONFIDENCE, HASH_TYPE_LIST, RETRY_STATUS_CODE,
                    SENTINEL_API, UTC_DATE_FORMAT, DATE_FORMAT, joe_config)
...
def submit_indicator(indicators_list: list) -> bool:
    ...
    try:
        ...
        logging.info(f"Indicator {ioc_list}")
        for i in range(
