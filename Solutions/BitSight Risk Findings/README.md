...
This folder contains the ARM artifacts for the reduced BitSight Risk Findings data connector. The connector focuses on a limited set of BitSight risk vectors and ingests only normalized **WARN** and **BAD** findings into Microsoft Sentinel.

## Description<a name="Description"></a>

The BitSight Risk Findings Data Connector supports targeted evidence-based cyber risk monitoring by bringing selected BitSight finding data into Microsoft Sentinel.
...
ii. Open **BitSight Risk Findings**
