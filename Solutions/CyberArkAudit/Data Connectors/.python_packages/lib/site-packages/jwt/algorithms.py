...
class HMACAlgorithm(Algorithm):
    ...
    def sign(self, msg: bytes, key: bytes) -> bytes:
        return hmac.new(key, msg, self.hash_alg).digest()       # CodeQL [SM02167] Being used for backwards compatibility.
...
if has_crypto:
    ...
    class RSAAlgorithm(Algorithm):
        ...
        def sign(self, msg: bytes, key: RSAPrivateKey) -> bytes:
            return key.sign(msg, padding.PKCS1v15(), self.hash_alg())   # CodeQL [SM04457] Being used for backwards compatibility

        def verify(self, msg: bytes, key: RSAPublicKey, sig: bytes) -> bool:
            try:
                key.verify(sig, msg, padding.PKCS1v15(), self.hash_alg())   # CodeQL [SM04457] Being used for backwards compatibility
                return True
    ...
    class ECAlgorithm(Algorithm):
        ...
        def from_jwk(jwk: str | JWKDict) -> AllowedECKeys:
            ...
            if curve == "P-256":
                ...
                if len(x) == len(y) == 32:
                    curve_obj = SECP256K1()  # CodeQL [SM04458] Being used for backwards compatibility
                else:
                    raise InvalidKeyError(
