...
_MEMCPY.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_size_t]  # Note:
    ...
    # Matching https://docs.microsoft.com/cpp/c-runtime-library/reference/memcpy-wmemcpy?view=msvc-160  # pylint: disable=line-too-long
...
class DataBlob(ctypes.Structure):  # pylint: disable=too-few-public-methods
    ...
    https://msdn.microsoft.com/7a06eae5-96d8-4ece-98cb-cf0710d2ddbd
    """
...
_err_description = {
    ...
    -2146892987: "The requested operation cannot be completed. "
        ...
        "See also https://docs.microsoft.com/windows/security/threat-protection/security-policy-settings/enable-computer-and-user-accounts-to-be-trusted-for-delegation",
