...
try:
    from bcrypt import kdf as _bcrypt_kdf   # CodeQL [SM04242] Module of cryptography library. This module is not being used. False Positive.
...
class _SSHFormatECDSA:
    ...
    def load_private(
        ...
        private_key = ec.derive_private_key(secret, self.curve)     # CodeQL [SM02597] This is for backward compatibility. Not being used in functions app.
        return private_key, data
    ...
    def verify_cert_signature(self) -> None:
        ...
        if isinstance(signature_key, ed25519.Ed25519PublicKey):
            ...
            signature_key.verify(
                ...
                padding.PKCS1v15(),     # CodeQL [SM02597] This is for backward compatibility. Not being used in functions app.
                hash_alg,
            )
    ...
    def sign(self, private_key: SSHCertPrivateKeyTypes) -> SSHCertificate:
        ...
        if isinstance(private_key, ed25519.Ed25519PrivateKey):
            ...
            signature = private_key.sign(
                f.tobytes(), padding.PKCS1v15(), hashes.SHA512()    # CodeQL [SM02597] This is for backward compatibility. Not being used in functions app.
            )
            fsig.put_sshstr(signature)
            f.put_sshstr(fsig.tobytes())
