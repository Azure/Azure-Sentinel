...
class ClientApplication(object):
    ...
    def initiate_auth_code_flow(
        ...
        :param domain_hint:
            ...
            `Auth Code Flow doc <https://docs.microsoft.com/azure/active-directory/develop/v2-oauth2-auth-code-flow#request-an-authorization-code>`_ and
            `domain_hint doc <https://docs.microsoft.com/openspecs/windows_protocols/ms-oapx/86fb452d-e34a-494e-ac61-e526e263b6d8>`_.
    ...
    def get_authorization_request_url(
        ...
        :param str response_type:
            ...
            `not recommended <https://docs.microsoft.com/azure/active-directory/develop/v2-oauth2-implicit-grant-flow#is-the-implicit-grant-suitable-for-my-app>`_.
    ...
    def acquire_token_by_refresh_token(self, refresh_token, scopes, **kwargs):
        ...
        :param list scopes:
            ...
            See `Scopes not resources <https://docs.microsoft.com/azure/active-directory/develop/migrate-python-adal-msal#scopes-not-resources>`_.
...
class ConfidentialClientApplication(ClientApplication):  # server-side web app
    ...
    def acquire_token_on_behalf_of(self, user_assertion, scopes, claims_challenge=None, **kwargs):
        ...
        See `detail docs here <https://docs.microsoft.com/azure/active-directory/develop/v2-oauth2-on-behalf-of-flow>`_ .

        The current middle-tier app has no user interaction to obtain consent.
        See how to gain consent upfront for your middle-tier app from this article.
        https://docs.microsoft.com/azure/active-directory/develop/v2-oauth2-on-behalf-of-flow#gaining-consent-for-the-middle-tier-application
