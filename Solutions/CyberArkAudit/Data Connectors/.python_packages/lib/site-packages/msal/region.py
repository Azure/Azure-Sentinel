...
def _detect_region_of_azure_vm(http_client):
    url = (
        ...
        # https://docs.microsoft.com/azure/virtual-machines/windows/instance-metadata-service?tabs=linux#route-parameters
        "/compute/location?format=text"

        # Location info is available since API version 2017-04-02
        # https://docs.microsoft.com/azure/virtual-machines/windows/instance-metadata-service?tabs=linux#response-1
    ...
    try:
        # https://docs.microsoft.com/azure/virtual-machines/windows/instance-metadata-service?tabs=linux#instance-metadata
