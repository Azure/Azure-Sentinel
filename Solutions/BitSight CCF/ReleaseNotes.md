...
|-------------|--------------------------------|--------------------------------------------------------------------|
| 4.0.0       | 18-05-2026                     | Replaced the deprecated Azure Function-based BitSight connector architecture with a CCF-based 2-ARM deployment model. Added the full integration scope for BitSight datasets, updated the connector deployment artifacts, and aligned the documentation with the new CCF implementation. |
