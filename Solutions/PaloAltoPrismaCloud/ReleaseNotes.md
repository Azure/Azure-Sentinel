...
|-------------|--------------------------------|--------------------------------------------------------------------|
| 3.0.5       | 09-04-2026                     | Fixed CCF **Data Connector** alert pagination, removed restrictive ALERT_STATUS_UPDATED filter, changed audit log polling from relative to absolute time, and added 30-minute query window delay to resolve data ingestion discrepancies |
