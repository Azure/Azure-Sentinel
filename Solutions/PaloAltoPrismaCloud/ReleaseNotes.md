...
|-------------|--------------------------------|--------------------------------------------------------------------|
| 3.0.5       | 09-04-2026                     | Fixed CCF **Data Connector** alert pagination, removed restrictive ALERT_STATUS_UPDATED filter, and changed audit log polling from relative to absolute time to resolve data ingestion discrepancies |
