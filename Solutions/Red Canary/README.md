...
- The analytic rule maps the first available IOC/evidence item to Sentinel entities while keeping alert cardinality to one alert per Red Canary detection ID. Full IOC arrays remain available in the raw `RedCanaryDetections_CL` record.
