...
def main(mytimer: func.TimerRequest, checkpoint2: str) -> str:
    ...
    start_date = checkpoint2 if checkpoint2 else DateHelper.get_utc_time_in_past(days=10)
    ...
    try:
        ...
        logging.error('Failed to get TTP Impersonation logs from Mimecast.', extra={'request_id': request_helper.request_id})
    ...
    try:
        ...
        logging.error('Failed to send TTP Impersonation to Azure Sentinel.', extra={'request_id': request_helper.request_id})
        e.request_id = request_helper.request_id
        raise e
    except Exception as e:
        logging.error('Unknown Exception raised.', extra={'request_id': request_helper.request_id})
