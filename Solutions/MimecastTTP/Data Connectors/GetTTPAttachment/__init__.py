...
def main(mytimer: func.TimerRequest, checkpoint1: str) -> str:
    ...
    start_date = checkpoint1 if checkpoint1 else DateHelper.get_utc_time_in_past(days=10)
    ...
    try:
        ...
        logging.error('Failed to get TTP Attachment logs from Mimecast.', extra={'request_id': request_helper.request_id})
    ...
    try:
        ...
        logging.error('Failed to send TTP Attachment to Azure Sentinel.', extra={'request_id': request_helper.request_id})
        e.request_id = request_helper.request_id
        raise e
    except Exception as e:
        logging.error('Unknown Exception raised.', extra={'request_id': request_helper.request_id})
