...
|-------------|--------------------------------|---------------------------------------------|
| 3.1.2       | 09-02-2026                     | Corrected Tenable_IE_CL table references in Data Connector Configuration. <br/> Update PyTenableUABuild value to 3.1.0 in template. <br/> Updating data connector UI page for multiple rsyslog configuration support in Tenable IE. |
