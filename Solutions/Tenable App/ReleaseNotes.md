...
|-------------|--------------------------------|---------------------------------------------|
| 3.1.2       | 30-01-2026                     | Updating data connector UI page for multiple rsyslog conf file support |
| 3.1.2       | 27-01-2026                     | Corrected Tenable_IE_CL table references in Data Connector Configuration. |
