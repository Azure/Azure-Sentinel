...
|-------------|--------------------------------|--------------------------------------------------------|
|  3.1.3      |  11-08-2026                    | Added CCF data connectors for Cisco Duo authentication, activity, and telephony logs. Updated analytics, hunting queries, and the workbook to use the CCF tables. Excluded the deprecated Azure Functions connector from the generated solution package. |
