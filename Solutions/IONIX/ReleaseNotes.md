...
|-------------|--------------------------------|--------------------------------------------------------------------------------------------------------------------|
| 3.1.1       | 23-04-2026                     | Fixed CCF paging (switched to `Offset`) and removed the explicit `CyberpionActionItems_CL` table schema resource to avoid migration deploy failures. |
