...
class StateManager:
    """State manager class for checkpoint operations using Azure File Share.

    This class will help to manage the state of the operation
    by saving and getting data from Azure Storage File Share.
    ...
    def get(self):
        ...
        Returns:
            str: The contents of the file, or None if file does not exist.
        """
        try:
