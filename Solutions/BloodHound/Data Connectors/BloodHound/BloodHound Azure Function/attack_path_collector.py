...
def run_attack_paths_collection_process() -> None:
    ...
    try:
        ...
        table_name = os.environ["ATTACK_PATHS_TABLE_NAME"]  # Use ATTACK PATHS Table Name
        ...
        token_id = os.environ["BLOODHOUND_TOKEN_ID"]
        token_key = os.environ["BLOODHOUND_TOKEN_KEY"]
