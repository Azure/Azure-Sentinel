...
-   Added action to check if the user has a manager assigned in the Microsoft Entra ID and notify the manager that the user is disabled<br>
    <strong>Note: Additional permissions must be assigned to the managed identity - Grant User.Read.All, User.ReadWrite.All, Directory.Read.All, Directory.ReadWrite.All. Full instructions available on https://github.com/Azure/Azure-Sentinel/tree/master/Solutions/Microsoft%20Entra%20ID/Playbooks/Block-AADUser</strong>
