...
|-------------|--------------------------------|---------------------------------------------|
| 3.1.2       | 16-09-2026                     | Migrated TeamCymruScoutLiveInvestigation and TeamCymruScoutEnrichIncident playbooks from the retired HTTP Data Collector API to the Logs Ingestion API. |
