...
|-------------|--------------------------------|-------------------------------------------------------------|
| 3.3.2       | 27-08-2026                     | Updated the Cisco Umbrella template to allow the S3 bucket prefix to be null or provided with a trailing slash, allowing customer root directories to work |
