...
|-------------|--------------------------------|-------------------------------------------------------------|
| 3.3.2       | 04-09-2026                     | Updated the Cisco Umbrella template to allow an empty S3 bucket prefix or one with or without a trailing slash, allowing customer root directories to work. |
