...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    # Get Name, VersionName, DocumentVersion and DocumentFormat from the request parameters
    ...
    if not (name and version_name and document_version and document_format):
        try:
    ...
    if name:
        try:
            ...
            try:
                ...
                return func.HttpResponse(f"Invalid Document Exception", status_code=400)
        ...
        return func.HttpResponse(
             "Pass Name (required) and (optional) VersionName, DocumentVersion and DocumentFormat parameter(s) in the query string or request body.",
             status_code=400
        )
