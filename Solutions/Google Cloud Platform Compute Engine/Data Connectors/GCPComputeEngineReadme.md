...
To access the terraform script for Log Setup [Click here](https://github.com/v-gsrihitha/v-gsrihitha/blob/main/GCPComputeEngine/GCPComputeEngineLogSetup.tf).
