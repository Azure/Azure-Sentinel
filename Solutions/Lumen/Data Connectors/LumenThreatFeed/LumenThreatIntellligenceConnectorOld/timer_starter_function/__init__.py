...
def download_threat_data_to_shared_disk(updater, indicator_types, max_indicators=None):
    ...
    logging.info(f"[Timer Trigger] Download complete. Total files: {len(temp_file_paths)}, Total indicators: ~{total_indicators_downloaded}")
...
async def main(mytimer: func.TimerRequest, starter: str) -> None:
    ...
    try:
        ...
        logging.debug(f"[Timer Trigger] Download complete. Files: {len(temp_file_paths)}, Total indicators: ~{total_indicators}")
        ...
        logging.debug(f"[Timer Trigger]    Total indicators: ~{total_indicators}")
