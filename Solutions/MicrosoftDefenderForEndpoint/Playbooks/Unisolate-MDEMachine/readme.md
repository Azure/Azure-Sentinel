...
## Screenshots
**Incident Trigger**
![Incident Trigger](./Unisolate-MDEMachine-incident-trigger/images/designerLight.png)

**Alert Trigger**
![Alert Trigger](./Unisolate-MDEMachine-alert-trigger/images/Unisolate-MDEMachine_alert.png)
