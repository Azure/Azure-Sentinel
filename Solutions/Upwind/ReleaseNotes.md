...
|-------------|--------------------------------|------------------------------------------------------------------------------------|
| 3.0.3       | 09-07-2026                     | Added **WorkspaceResourceGroup** parameter to the Function App ARM template so the Log Analytics workspace can reside in a different resource group than the deployed resources. |
