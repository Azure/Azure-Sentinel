...
| `WorkspaceResourceGroup`         | *(optional)* Resource group containing that workspace, if different from the one you deploy into. Defaults to the deployment's own resource group. |
