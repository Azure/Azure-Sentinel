...
PAGE_SIZE = 100
DETECTION_PAGE_SIZE = 10
MAX_EXECUTION_TIME = 570
RETRY_STATUS_CODE = [429, 500, 503]
MAX_SLEEP_TIME = 30
MIN_SLEEP_TIME = 5
...
AUDIT_ENDPOINT = "/api/v3.4/events/audits"
ENTITY_SCORING_TABLE_NAME = os.environ.get("Entity_Scoring_Table_Name")
LOG_LEVEL = os.environ.get("LogLevel", "")
DETECTIONS_ENDPOINT = "/api/v3.4/events/detections"
DETECTIONS_DETAILS_ENDPOINT = "/api/v3.4/detections"
ENTITY_SCORING_ENDPOINT = "/api/v3.4/events/entity_scoring"
USER_AGENT = "Vectra-Sentinel-2.0.0"
LOCKDOWN_TABLE_NAME = os.environ.get("Lockdown_Table_Name")
LOCKDOWN_ENDPOINT = "/api/v3.4/lockdown"
HEALTH_NAME = "Health"
HEALTH_TABLE_NAME = os.environ.get("Health_Table_Name")
HEALTH_ENDPOINT = "/api/v3.4/health"
AZURE_CLIENT_ID = os.environ.get("AZURE_CLIENT_ID")
AZURE_CLIENT_SECRET = os.environ.get("AZURE_CLIENT_SECRET")
AZURE_TENANT_ID = os.environ.get("AZURE_TENANT_ID")
INCLUDE_SCORE_DECREASE = os.environ.get("IncludeScoreDecrease").lower()
ENTITIES_ENDPOINT = "/api/v3.4/entities"
ASSIGNMENT_ENDPOINT = "/api/v3.4/assignments"
...
EXCLUDE_GROUP_DETAILS_FROM_DETECTIONS = os.environ.get("ExcludeGroupDetailsFromDetections", "false").lower() == 'true'
