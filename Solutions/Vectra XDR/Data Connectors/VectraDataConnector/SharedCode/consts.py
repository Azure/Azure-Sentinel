...
ENTITY_SCORING_DETECTIONS_CLIENT_ID = os.environ.get("Entity_Scoring_Detections_Client_Id", "").strip()
ENTITY_SCORING_DETECTIONS_CLIENT_SECRET = os.environ.get("Entity_Scoring_Detections_Client_Secret_Key", "").strip()
AUDIT_LOCKDOWN_CLIENT_ID = os.environ.get("Audit_Lockdown_Client_Id", "").strip()
AUDIT_LOCKDOWN_CLIENT_SECRET = os.environ.get("Audit_Lockdown_Client_Secret_Key", "").strip()
