...
$sourceFile = Join-Path -Path $PSScriptRoot -ChildPath "Playbooks" | Join-Path -ChildPath "Cohesity_Restore_From_Last_Snapshot" | Join-Path -ChildPath "azuredeploy.json"
