...
async def main(msg: func.QueueMessage ):    
    try:            
        ...
        for obj in body:
            ...
            logging.info('link is {}, bucket is {}, sqs message id is {}, file size is {} bytes'.format(link, bucket, messageId, file_size))
        ...
        logging.info('Total events sent to Logs Ingestion API is {}. File count in this queue message is {}. Accumulated  file size is {}'.format(total_events, len(body), accumulated_file_size))
