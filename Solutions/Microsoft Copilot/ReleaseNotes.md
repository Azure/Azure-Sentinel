...
|-------------|--------------------------------|---------------------------------------------------------------------------------------------------|
| 3.0.2       | 24-03-2026                     | Update Solution and Connector Descriptions. <br> Added a **Analytic rules** and **Hunting Queries** for Microsoft Copilot Activity Monitoring and detection.|
