...
|-------------|--------------------------------|---------------------------------------------------------------------------------------------------|
| 3.0.2       | 24-03-2026                     | Update Solution and Connector Descriptions. <br> Added a **Analytic rules**, **Hunting Queries** and **Workbook** for Microsoft Copilot Activity Monitoring and detection.|
