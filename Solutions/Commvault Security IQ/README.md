...
*   Under **Configuration**, enter the following:
    - **Commvault Environment Endpoint URL**: Your Commvault Cloud API base URL including the `/commandcenter/api` path (e.g., `https://your-commvault-endpoint/commandcenter/api`)
