...
|-------------|--------------------------------|----------------------------------------|
| 3.0.4       | 06-07-2026                     | Updated CCP **Data Connector** to use 1Password Events API **v2** endpoints (signinattempts, auditevents, itemusages) and added v2 fields (account_uuid, actor_type, actor_account_uuid, user_type, user_account_uuid) to the **OnePasswordEventLogs_CL** table. |
