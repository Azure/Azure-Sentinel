...
foreach ($connector in $connectors.connectors) {
    ...
    #MicrosoftDefenderforCloud connector (1)
    ...
    #MicrosoftCloudAppSecurity connector    (3)
    ...
    #Microsoft Defender for IoT connector   (4)
    ...
    #Microsoft Defender for Office 365 (Preview) connector  (6)
    ...
    #ThreatIntelligencePlatforms connector      (7)
    ...
    #Microsoft Defender for Endpoint connector    (8)
    ...
    #Microsoft Defender for Identity connector    (9)
    ...
    #MicrosoftThreatIntelligence connector    (10)
    ...
    #Azure Active Directory Identity Protection connector   (11)
    ...
    # Azure Active Directory connector  (12)
