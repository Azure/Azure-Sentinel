...
- [template_InfobloxCloudDataConnectorAma.JSON](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Infoblox/Data%20Connectors/InfobloxCEFDataConnector/template_InfobloxCloudDataConnectorAma.JSON)
...
- [Infoblox_API_FunctionApp.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Infoblox/Data%20Connectors/InfobloxCloudDataConnector/Infoblox_API_FunctionApp.json)
...
- [InfobloxSOCInsightsDataConnector_AMA.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Infoblox/Data%20Connectors/InfobloxSOCInsights/InfobloxSOCInsightsDataConnector_AMA.json)
...
- [InfobloxSOCInsightsDataConnector_API.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Infoblox/Data%20Connectors/InfobloxSOCInsights/InfobloxSOCInsightsDataConnector_API.json)
...
- [InfobloxSOCInsightsDataConnector_Legacy.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Infoblox/Data%20Connectors/InfobloxSOCInsights/InfobloxSOCInsightsDataConnector_Legacy.json)
...
| `Infoblox_Failed_Indicators_CL` | Infoblox Data Connector via REST API |
| `dossier_atp_CL` | Infoblox Data Connector via REST API |
| `dossier_atp_threat_CL` | Infoblox Data Connector via REST API |
| `dossier_dns_CL` | Infoblox Data Connector via REST API |
| `dossier_geo_CL` | Infoblox Data Connector via REST API |
| `dossier_infoblox_web_cat_CL` | Infoblox Data Connector via REST API |
| `dossier_inforank_CL` | Infoblox Data Connector via REST API |
| `dossier_malware_analysis_v3_CL` | Infoblox Data Connector via REST API |
| `dossier_nameserver_CL` | Infoblox Data Connector via REST API |
| `dossier_nameserver_matches_CL` | Infoblox Data Connector via REST API |
| `dossier_ptr_CL` | Infoblox Data Connector via REST API |
| `dossier_rpz_feeds_CL` | Infoblox Data Connector via REST API |
| `dossier_rpz_feeds_records_CL` | Infoblox Data Connector via REST API |
| `dossier_threat_actor_CL` | Infoblox Data Connector via REST API |
| `dossier_tld_risk_CL` | Infoblox Data Connector via REST API |
| `dossier_whitelist_CL` | Infoblox Data Connector via REST API |
| `dossier_whois_CL` | Infoblox Data Connector via REST API |
