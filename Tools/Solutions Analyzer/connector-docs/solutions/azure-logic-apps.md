...
- [AzureLogicApps_CCP.JSON](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Azure%20Logic%20Apps/Data%20Connectors/AzureLogicApps_CCP.JSON)
...
|-------|-------------------|
| `AzureDiagnostics` | Azure Logic Apps |
