...
- [ApigeeX_FunctionApp.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Google%20Apigee/Data%20Connectors/ApigeeX_FunctionApp.json)
...
- [GoogleApigeeXLog_ConnectorDefinition.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Google%20Apigee/Data%20Connectors/GoogleApigeeXLog_CCP/GoogleApigeeXLog_ConnectorDefinition.json)
...
|-------|-------------------|
| `ApigeeX_CL` | [DEPRECATED] Google ApigeeX |
| `GCPApigee` | Google ApigeeX (via Codeless Connector Framework) |
