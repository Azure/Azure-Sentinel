...
- [RSASecurID.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/RSA%20SecurID/Data%20Connectors/RSASecurID.json)
...
|-------|-------------------|
| `Syslog` | [Deprecated] RSA® SecurID (Authentication Manager) |
