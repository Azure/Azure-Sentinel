...
- [template_OfficeIRM.JSON](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/MicrosoftPurviewInsiderRiskManagement/Data%20Connectors/template_OfficeIRM.JSON)
...
|-------|-------------------|
| `SecurityAlert` | Microsoft 365 Insider Risk Management |
