...
- [Connector_McAfee_ePO.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/McAfee%20ePolicy%20Orchestrator/Data%20Connectors/Connector_McAfee_ePO.json)
...
|-------|-------------------|
| `Syslog` | [Deprecated] McAfee ePolicy Orchestrator (ePO) |
