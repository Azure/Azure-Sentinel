...
| **Solution Folder** | [https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/JoeSandbox](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/JoeSandbox) |
...
[→ View full connector details](../connectors/joesandbox.md)
...
|-------|-------------------|
| `ThreatIntelligenceIndicator` | [JoeSandboxThreatIntelligence](../connectors/joesandbox.md) |
