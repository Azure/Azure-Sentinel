...
- [esetSmc.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Eset%20Security%20Management%20Center/Data%20Connectors/esetSmc.json)
...
|-------|-------------------|
| `eset_CL` | Eset Security Management Center |
