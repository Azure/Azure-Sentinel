...
- [Connector_Cisco_ISE.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Cisco%20ISE/Data%20Connectors/Connector_Cisco_ISE.json)
...
|-------|-------------------|
| `Syslog` | [Deprecated] Cisco Identity Services Engine |
