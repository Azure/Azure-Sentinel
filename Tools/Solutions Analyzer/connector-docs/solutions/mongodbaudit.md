...
- [Connector_MongoDBAudit.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/MongoDBAudit/Data%20Connectors/Connector_MongoDBAudit.json)
...
|-------|-------------------|
| `MongoDBAudit_CL` | [Deprecated] MongoDB Audit |
