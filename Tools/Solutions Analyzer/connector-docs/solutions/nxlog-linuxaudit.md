...
- [NXLogLinuxAudit.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/NXLog%20LinuxAudit/Data%20Connectors/NXLogLinuxAudit.json)
...
|-------|-------------------|
| `LinuxAudit_CL` | NXLog LinuxAudit |
