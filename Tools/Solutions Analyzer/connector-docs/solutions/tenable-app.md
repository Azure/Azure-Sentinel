...
|-------|-------------------|
| `Tenable_IE_CL` | Tenable Identity Exposure |
| `Tenable_VM_Asset_CL` | Tenable Vulnerability Management |
| `Tenable_VM_Compliance_CL` | Tenable Vulnerability Management |
| `Tenable_VM_Vuln_CL` | Tenable Vulnerability Management |
