...
- [AzureStreamAnalytics_CCP.JSON](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Azure%20Stream%20Analytics/Data%20Connectors/AzureStreamAnalytics_CCP.JSON)
...
|-------|-------------------|
| `AzureDiagnostics` | Azure Stream Analytics |
