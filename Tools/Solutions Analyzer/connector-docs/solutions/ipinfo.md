...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Abuse_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Carrier_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Company_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Country_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Domain_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Location_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Location_extended_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Privacy_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_Privacy_extended_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_RIRWHOIS_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_RWHOIS_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_WHOIS_ASN_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_WHOIS_MNT_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_WHOIS_NET_CL` |
...
| Attribute | Value |
|:-------------------------|:---|
| **Tables Ingested** | `Ipinfo_WHOIS_ORG_CL` |
