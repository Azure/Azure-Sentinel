...
- [IONIXSecurityLogs.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/IONIX/Data%20Connectors/IONIXSecurityLogs.json)
...
|-------|-------------------|
| `CyberpionActionItems_CL` | IONIX Security Logs |
