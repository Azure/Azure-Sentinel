...
- [TrendMicroTippingPoint.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Trend%20Micro%20TippingPoint/Data%20Connectors/TrendMicroTippingPoint.json)
...
|-------|-------------------|
| `CommonSecurityLog` | [Deprecated] Trend Micro TippingPoint via Legacy |
