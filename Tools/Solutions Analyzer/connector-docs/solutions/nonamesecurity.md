...
- [Connector_RESTAPI_NonameSecurity.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/NonameSecurity/Data%20Connectors/Connector_RESTAPI_NonameSecurity.json)
...
|-------|-------------------|
| `NonameAPISecurityAlert_CL` | Noname Security for Microsoft Sentinel |
