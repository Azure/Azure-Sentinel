...
- [AzureEventHub_CCP.JSON](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Azure%20Event%20Hubs/Data%20Connectors/AzureEventHub_CCP.JSON)
...
|-------|-------------------|
| `AzureDiagnostics` | Azure Event Hub |
