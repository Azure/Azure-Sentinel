...
- [RadiflowIsid.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Radiflow/Data%20Connectors/RadiflowIsid.json)
...
|-------|-------------------|
| `CommonSecurityLog` | Radiflow iSID via AMA |
