...
- [Connector_Syslog_SymantecVIP.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Symantec%20VIP/Data%20Connectors/Connector_Syslog_SymantecVIP.json)
...
|-------|-------------------|
| `Syslog` | [Deprecated] Symantec VIP |
