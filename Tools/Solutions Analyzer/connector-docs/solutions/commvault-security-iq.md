...
- [CommvaultSecurityIQ_API_AzureFunctionApp.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Commvault%20Security%20IQ/Data%20Connectors/CommvaultSecurityIQ_API_AzureFunctionApp.json)
...
|-------|-------------------|
| `CommvaultSecurityIQ_CL` | CommvaultSecurityIQ |
