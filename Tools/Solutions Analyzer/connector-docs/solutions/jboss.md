...
- [Connector_JBoss.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/JBoss/Data%20Connectors/Connector_JBoss.json)
...
|-------|-------------------|
| `JBossLogs_CL` | [Deprecated] JBoss Enterprise Application Platform |
