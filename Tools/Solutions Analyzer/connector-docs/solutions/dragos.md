...
- [dragosSitestoreDataConnectorDefinition.json](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Dragos/Data%20Connectors/DragosSiteStore_CCP/dragosSitestoreDataConnectorDefinition.json)
...
|-------|-------------------|
| `DragosAlerts_CL` |  Dragos Notifications via Cloud Sitestore |
