...
- [template_WAF.JSON](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Azure%20Web%20Application%20Firewall%20%28WAF%29/Data%20Connectors/template_WAF.JSON)
...
|-------|-------------------|
| `AzureDiagnostics` | Azure Web Application Firewall (WAF) |
