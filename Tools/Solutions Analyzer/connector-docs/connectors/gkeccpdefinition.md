...
| **Publisher** | Microsoft |
| **Tables Ingested** | [`GKEAPIServer`](../tables-index.md#gkeapiserver), [`GKEApplication`](../tables-index.md#gkeapplication), [`GKEAudit`](../tables-index.md#gkeaudit), [`GKEControllerManager`](../tables-index.md#gkecontrollermanager), [`GKEHPADecision`](../tables-index.md#gkehpadecision), [`GKEScheduler`](../tables-index.md#gkescheduler) |
