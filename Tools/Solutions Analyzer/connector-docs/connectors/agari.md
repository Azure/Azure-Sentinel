...
| **Connector ID** | `Agari` |
| **Publisher** | Agari |
| **Tables Ingested** | [`agari_apdpolicy_log_CL`](../tables-index.md#agari_apdpolicy_log_cl), [`agari_apdtc_log_CL`](../tables-index.md#agari_apdtc_log_cl), [`agari_bpalerts_log_CL`](../tables-index.md#agari_bpalerts_log_cl) |
