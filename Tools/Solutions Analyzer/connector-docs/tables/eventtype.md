...
| Attribute | Value |
|:----------|:------|
| **Solutions** | [Proofpoint On demand(POD) Email Security](../solutions/proofpoint-on-demand%28pod%29-email-security.md) |
| **Connectors** | [[Deprecated] Proofpoint On Demand Email Security](../connectors/proofpointpod.md) |

⚠️ **Note:** This is a custom table name used by specific solutions and may contain solution-specific data.
