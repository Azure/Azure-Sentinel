...
- [Apache - Apache 2.4.49 flaw CVE-2021-41773](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheCVE-2021-41773.yaml)
- [Apache - Command in URI](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheCommandInURI.yaml)
- [Apache - Known malicious user agent](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheKnownMaliciousUserAgents.yaml)
- [Apache - Multiple client errors from single IP](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheMultipleClientErrorsFromSingleIP.yaml)
- [Apache - Multiple server errors from single IP](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheMultipleServerErrorsRequestsFromSingleIP.yaml)
- [Apache - Private IP in URL](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApachePrivateIpInUrl.yaml)
- [Apache - Put suspicious file](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApachePutSuspiciousFiles.yaml)
- [Apache - Request from private IP](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheRequestFromPrivateIP.yaml)
- [Apache - Request to sensitive files](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheRequestToSensitiveFiles.yaml)
- [Apache - Requests to rare files](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Analytic%20Rules/ApacheRequestToRareFile.yaml)
...
**In solution [ApacheHTTPServer](../solutions/apachehttpserver.md):**
- [Apache - Rare URLs requested](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheRareURLsRequested.yaml)
- [Apache - Rare files requested](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheRareFilesRequested.yaml)
- [Apache - Rare user agents](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheRareUserAgents.yaml)
- [Apache - Rare user agents with client errors](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheRareUAWithClientErrors.yaml)
- [Apache - Requests to unexisting files](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheRequestsToUnexistingFiles.yaml)
- [Apache - Top Top files requested](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheFilesRequested.yaml)
- [Apache - Top URLs with client errors](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheUrlClienterrors.yaml)
- [Apache - Top URLs with server errors](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheUrlServerErrors.yaml)
- [Apache - Top files requested with errors](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheFilesErrorRequests.yaml)
- [Apache - Unexpected Post Requests](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Hunting%20Queries/ApacheUnexpectedPostRequests.yaml)
...
**In solution [ApacheHTTPServer](../solutions/apachehttpserver.md):**
- [ApacheHTTPServer](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/ApacheHTTPServer/Workbooks/ApacheHTTPServer.json)
