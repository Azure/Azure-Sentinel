...
param (
    ...
    [string]$dataFileName,
    [Parameter(Mandatory = $true, ParameterSetName = "Pipeline", Position = 4)]
    [string]$dataConnectorFolderName,
    [Parameter(Mandatory = $true, ParameterSetName = "Pipeline", Position = 5)]
    [string]$dataFolderActualName,
    [Parameter(Mandatory = $true, ParameterSetName = "Pipeline", Position = 6)]
    [string]$instrumentationKey,
    [Parameter(Mandatory = $true, ParameterSetName = "Pipeline", Position = 7)]
    [string]$pullRequestNumber,
    [Parameter(Mandatory = $true, ParameterSetName = "Pipeline", Position = 8)]
    [string]$runId,
    [Parameter(Mandatory = $true, ParameterSetName = "Pipeline", Position = 9)]
    [string]$calculatedPackageVersion,
    [Parameter(Mandatory = $true, ParameterSetName = "Pipeline", Position = 10)]
    [string]$defaultPackageVersion,
    [Parameter(ParameterSetName = "Pipeline", Position = 11)]
