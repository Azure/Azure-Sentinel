...
$path = "\home\runner\work\packagingrepo\packagingrepo\Solutions\Alibaba Cloud\Data\Solution_Alibaba_Cloud.json"
...
foreach ($inputFile in $(Get-ChildItem $path)) {
    ...
    if ($dataFileIndex -gt 0)
    {
        ...
        $inputJsonPath = "\home\runner\work\packagingrepo\packagingrepo\Solutions\Alibaba Cloud\Data\Solution_Alibaba_Cloud.json"
    ...
    elseif ($parserFileIndex -gt 0) {
        ...
        $inputJsonPath = "\home\runner\work\packagingrepo\packagingrepo\Solutions\Alibaba Cloud\Parsers\AliCloud.txt"
    ...
    $basePath = $(if ($contentToImport.BasePath) { $contentToImport.BasePath + "/" } else { "https://raw.githubusercontent.com/v-amolpatil/packagingrepo/test1/" })
    ...
    Write-Host "Destination of file location: $solutionFolder , Folder zip at: $solutionFolder/$zipPackageName"
