...
class SkillContractTests(unittest.TestCase):
    ...
    def test_solution_manager_is_single_connected_agent(self):
        ...
        self.assertIn("## Automatic AR/CD qualification", text)
        self.assertIn("Temporary five-minute AR/CD clones", text)
    ...
    def test_optional_testing_requires_startup_before_target_preflight(self):
        ...
        self.assertIn("## Automatic agent mode", text)
        self.assertIn("scenario.ingestion.contract", text)
