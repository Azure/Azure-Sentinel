...
namespace AzureSentinel_ManagementAPI.Actions
{
    public class ActionsController
    {
        ...
        /// <returns></returns>
        public async Task CreateAction(string ruleId)
        {
            int insId = Utils.SelectInstance(azureConfigs);
            ActionRequestPayload[] actions = Utils.LoadPayload<ActionRequestPayload[]>("ActionPayload.json");
        ...
        /// <returns></returns>
        public async Task<string> DeleteAction(string ruleId, string actionId)
        {
            try
            {
        ...
        /// <param name="actionId"></param>
        /// <returns></returns>
        public async Task<string> GetActionById(string ruleId, string actionId)
        {
            try
            {
                var insId = Utils.SelectInstance(azureConfigs);
        ...
        /// <param name="ruleId"></param>
        /// <returns></returns>
        public async Task<string> GetActionsByRule(string ruleId)
        {
            try
            {
                var insId = Utils.SelectInstance(azureConfigs);
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Utils.WriteJsonStringToFile($"GetActionsByRule_{azureConfigs[insId].InstanceName}.json", JsonConvert.SerializeObject(values, Formatting.Indented), false);
                    return res;
                }
