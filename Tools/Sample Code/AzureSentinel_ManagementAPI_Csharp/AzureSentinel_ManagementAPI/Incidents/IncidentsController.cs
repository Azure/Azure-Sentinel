...
namespace AzureSentinel_ManagementAPI.Incidents
{
    public class IncidentsController
    {
        ...
        {
            var incidents = Utils.LoadPayload<IncidentPayload[]>("IncidentPayload.json");
        ...
        /// <returns></returns>
        public async Task<string> UpdateIncident(string incidentId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task BatchUpdateIncidents()
        {
            var insId = Utils.SelectInstanceOrApplyAll(azureConfigs);
        ...
        {
            var incidentUpdates = Utils.LoadPayload<IncidentPayload[]>("IncidentPayload.json");
        ...
        {
            var insId = Utils.SelectInstance(azureConfigs);
            var incidentUpdates = Utils.LoadPayload<IncidentPayload[]>("GetIncidents0.json");
        ...
        /// <param name="incidentId"></param>
        /// <returns></returns>
        public async Task<string> DeleteIncident(string incidentId)
        {
            try
            {
                var insId = Utils.SelectInstance(azureConfigs);
        ...
        public async Task GetIncidents()
        {
            ...
            if (insId != -1)
            {
                ...
                Utils.WriteJsonStringToFile($"GetIncidents_{azureConfigs[insId].InstanceName}.json", formattedRes, false);
            ...
            else
            {
                for (var i = 0; i < azureConfigs.Length; i++)
                {
                    ...
                    var formattedRes = JsonConvert.SerializeObject(values, Formatting.Indented);
                    Utils.WriteJsonStringToFile($"GetIncidents_{azureConfigs[i].InstanceName}.json", formattedRes, false);
                    Console.WriteLine(formattedRes);
                    continue;
                }
            }
        ...
        public async Task CreateIncidentComment(string incidentId)
        {
            ...
            var comments = Utils.LoadPayload<IncidentCommentPayload[]>("IncidentCommentPayload.json");
        ...
        /// <returns></returns>
        public async Task<string> GetIncidentCommentById(string incidentId, string commentId)
        {
            try
            {
                var insId = Utils.SelectInstance(azureConfigs);
        ...
        /// <param name="incidentId"></param>
        /// <returns></returns>
        public async Task<string> GetAllIncidentComments(string incidentId)
        {
            try
            {
                var insId = Utils.SelectInstance(azureConfigs);
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Utils.WriteJsonStringToFile($"GetAllIncidentComments_{azureConfigs[insId].InstanceName}.json", JsonConvert.SerializeObject(values, Formatting.Indented), false);
                    return res;
                }
