...
namespace AzureSentinel_ManagementAPI.DataConnectors
{
    public class DataConnectorsController
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task GetDataConnectors()
        {
        ...
        private async Task GetDataConnectorsByInstance(int i)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Utils.WriteJsonStringToFile($"GetDataConnectors_{azureConfigs[i].InstanceName}.json", formattedRes, false);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task CreateDataConnector()
        {
            var insId = Utils.SelectInstanceOrApplyAll(azureConfigs);
        ...
        {
            var dataConnectors = Utils.LoadPayload<ASCDataConnectorPayload[]>("DataConnectorPayload.json");
        ...
        /// <returns></returns>
        public async Task<string> DeleteDataConnector(string dataConnectorId)
        {
            try
            {
