...
try {
    ...
    # Get Solution Name
    . $PSScriptRoot/getSolutionName.ps1 $runId $pullRequestNumber $instrumentationKey $true
    ...
    . $PSScriptRoot/newOrExistingSolution.ps1 $solutionName $pullRequestNumber $runId $baseFolderPath $instrumentationKey $true
    ...
    . $PSScriptRoot/checkSkipPackagingInfo.ps1 $solutionName $pullRequestNumber $runId $baseFolderPath $instrumentationKey $true
