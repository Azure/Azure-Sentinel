...
function isLogoSVG(LogoImagesFileNames) {
    return LogoImagesFileNames.toLowerCase().endsWith('.svg');
}
function isLogoSizeValid(filePath) {
    var result = true;
...
export function isValidLogoImage(LogoImagesPath) {
...
;
//# sourceMappingURL=logoImageChecker.js.map