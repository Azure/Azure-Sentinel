...
import { ConnectorCategory } from "../dataConnector.js";
...
export function isValidPermissions(permissions, connectorCategory) {
...
function isValidCustomPermission(permissions) {
