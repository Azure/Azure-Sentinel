...
namespace Kqlvalidations.Tests
{
    public class DetectionTemplateSchemaValidationTests
    {
        ...
        public void Validate_DetectionTemplates_AllFilesAreYamls()
        {
            ...
            Assert.True(AllFiles.Count == yamlFiles.Count + numberOfNotYamlFiles,  $"All the files in detections and solution (Analytics rules) folder are supposed to end with .yaml {numberOfNotYamlFiles} {AllFiles.Count} {yamlFiles.Count} {AllFiles}");
        }
