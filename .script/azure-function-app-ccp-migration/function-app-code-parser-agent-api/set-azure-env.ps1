...
$env:UAMI_CLIENT_ID = ""
$env:PROJECT_ENDPOINT = "https://sachin-azure-ai-foundry.services.ai.azure.com/api/projects/default-project"
$env:MODEL_DEPLOYMENT_NAME = "sachin-agent-gpt-4.1"
$env:AZURE_BING_CONNECTION_ID = ""
