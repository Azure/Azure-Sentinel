...
export function IsValidSolutionDomainsVerticals(filePath) {
    ...
    if (filePath.endsWith("mainTemplate.json")) {
        ...
        const filteredResource = resources.filter(function (resource) {
...
//# sourceMappingURL=validDomainsVerticals.js.map